...
use MyBB\Core\Database\Migrator;
use MyBB\Core\Events\ExtensionWasDisabled;
use MyBB\Core\Events\ExtensionWasEnabled;
use MyBB\Core\Events\ExtensionWasUninstalled;
