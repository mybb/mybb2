...
namespace MyBB\Core\Traits;

use Illuminate\Database\Eloquent\Model;

trait UserActivityStoreable
{
	/**
	 ...
	 * @return void
	 */
	public static function bootUserActivityStoreable()
	{
	 ...
	 */
	public static function getActivityDetails($model)
	{
		return [];
	}
	...
	{
		return $this->morphMany('MyBB\Core\Database\Models\UserActivity', 'activityHistorable', 'activity_type', 'activity_id');
	}
}
