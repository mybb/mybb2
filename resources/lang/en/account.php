...
return [
    ...
    'message_order'              => 'Message Order in Conversations',
    'message_order_description'  => 'Messages within <a href=":link">conversations</a> can be sorted by date with the oldest messages shown first (ascending order) or with the newest messages shown first (descending order).',
    'message_order_asc'          => 'Oldest First',
    'message_order_desc'         => 'Newest First',
    ...
    'notify_on_mention'          => 'Mentions me in a post',
    'notify_on_reply'            => 'Replies to a topic I\'m following',
    'notify_on_new_post'         => 'Posts a new topic to a forum I\'m following',
    ...
    'notify_on_moderation_post'  => 'Posts a topic, reply, or attachment requiring moderation',
    'notify_on_report'           => 'Reports a post, message, or profile to a moderator',
    'notify_on_username_change'  => 'Requests a username change',
    'notification_mails'         => 'Notification Summary Emails',
    'notification_mails_desc'    => 'You can choose to receive daily or weekly summary emails of any <a href=":noti">forum notifications</a> you receive. This does not affect any instant notifications you have opted to receive for topics or forums you are <a href=":following">following</a>.',
    ...
    'receive_messages'       => 'Receive direct messages from other members',
    'block_blocked_messages' => 'Prevent blocked users from sending me direct messages',
    'hide_blocked_posts'     => 'Hide posts and topics by blocked users',
    'only_buddy_messages'    => 'Only allow <a href=":link">users I\'m following</a> to send me direct messages',
